...
public:
        ...
        const ray &r, double t_min, double t_max, hit_record &rec) const override
    {
        ...
        // have to rotate in the opposite direction, and sin(-theta) = -sin(theta),
        // You can assume that you are the axis, how do you move to get the final result 
